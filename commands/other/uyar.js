...
exports.run = (client, message, args) => {
    const member = message.mentions.members.first() || message.guild.members.cache.get(args[0]);
        if (message.author.id !== '539506680140922890'){
            if(!message.member.hasPermission("KICK_MEMBERS")) return message.channel.send('Üzgünüm, buna yetkin yok :grinning:')
        }
   ...
   exports.help = {
       name: 'uyar',
       description: 'Kişiyi sebebiyle uyarır.',
       usage: 'uyar @birisi sebebi'
   };
