...
exports.run = (client, message, args) => {
    ...
    if (!mesaj) return message.channel.send('Şık sayısını veya anketi unuttun! Doğru kullanım: !anket 2 deneme\nAma sakın böyle bişey yapma :)',{ files: ["https://i.ytimg.com/vi/Sflh1cjhJx8/maxresdefault.jpg"] });
